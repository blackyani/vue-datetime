...
.active ~ .material-label {
  -webkit-transform: translateY(-18px) translateX(-2px) scale(1);
  -moz-transform: translateY(-18px) translateX(-2px) scale(1);
  transform: translateY(-18px) translateX(-2px) scale(1);
